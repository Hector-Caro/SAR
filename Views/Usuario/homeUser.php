      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
            <div class="about-img">
              <img src="../client-site/assets/img/hambu.jpg" alt="">
            </div>
          </div>
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    ...
                    <p class="fst-italic">Cada bocado de la "Cheese Burger" es una explosión de sabores, una mezcla perfecta de lo salado, lo jugoso y lo delicioso.
                      Es una experiencia que te llevará directamente al cielo gastronómico.</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="../client-site/assets/img/hambu1.png " alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-2">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Papi costeña</h3>
                    <p class="fst-italic">"Papi Costeña" es mucho más que una salchipapa; es una experiencia culinaria que te transportará a las costas tropicales con cada bocado.
                      Una deliciosa combinación de sabores que rinde homenaje a la rica cultura gastronómica de la costa.</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="../client-site/assets/img/salchi1.png" alt="" class="img-fluid" style="position: relative;top: -150px;">
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane" id="tab-4">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    ...
                    <p class="fst-italic">Las "Alitas de Pollo" son el aperitivo favorito de todos, famosas por su sabor tentador, textura crujiente y delicioso toque picante.
                      Son perfectas para compartir con amigos y familiares mientras disfrutan de momentos inolvidables.</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="../client-site/assets/img/alitas.png" alt="" class="img-fluid" style="position: relative; top: -120px;">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-5">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Papicrispy</h3>
                    <p class="fst-italic">Las "Papicryspy" son la combinación perfecta entre papas fritas y chips, logrando un bocadillo inigualable que te hará volver por más.
                      Son la opción ideal para disfrutar en solitario, compartir con amigos o como acompañamiento en cualquier comida.</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="../client-site/assets/img/salchi2.png" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                <div class="col-lg-6">
                  <img src="../client-site/assets/img/modelia.jpg" class="img-fluid" alt="salchipaperia modelia">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                  ...
                  <p class="fst-italic">
                    Ubicada en el corazón de Modelia, nuestra sede principal es el lugar perfecto para disfrutar de nuestras deliciosas salchipapas. Con un ambiente acogedor y familiar, te invitamos a que vengas con amigos y familiares para disfrutar de una experiencia gastronómica única.
                  </p> <br>
                  <ul>
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                <div class="col-lg-6">
                  <img src="../client-site/assets/img/suba.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                  ...
                  <p class="fst-italic">
                    En el la zona más concurrida de Suba, nuestra sede te ofrece un espacio acogedor para disfrutar de nuestras salchipapas con amigos y seres queridos. Nuestro ambiente amigable y atención excepcional harán que te sientas como en casa. Te esperamos para satisfacer tus antojos más deliciosos.
                  </p> <br>
                  <ul>
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                <div class="col-lg-6">
                  <img src="../client-site/assets/img/Kenedy.jpg" class="img-fluid" alt="">
                </div>
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                <div class="col-lg-6">
                  <img src="../client-site/assets/img/Bosa.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                  ...
                  <p class="fst-italic">
                    En el encantador barrio de Bosa, nuestra sede te brinda una experiencia culinaria inigualable. Con un ambiente relajado y acogedor, te invitamos a probar nuestras salchipapas y descubrir por qué somos el lugar preferido de los amantes de la comida rápida.
                  </p> <br>
                  <ul>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../client-site/assets/img/suba.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../client-site/assets/img/suba.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../client-site/assets/img/kenedy.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../client-site/assets/img/kenedy.jpg" alt="" class="img-fluid" style="height: 350px; width: 100%;">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../client-site/assets/img/modelia.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../client-site/assets/img/modelia.jpg" alt="" class="img-fluid" style="height: 350px; width: 100%;">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../client-site/assets/img/galeria5.jpeg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../client-site/assets/img/galeria5.jpeg" alt="" class="img-fluid" style="height: 350px; width: 100%;">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../client-site/assets/img/galeria6.png" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../client-site/assets/img/galeria6.png" alt="" class="img-fluid" style="height: 350px; width: 100%;">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../client-site/assets/img/galeria7.jpeg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../client-site/assets/img/galeria7.jpeg" alt="" class="img-fluid" style="height: 350px; width: 100%;">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="../client-site/assets/img/galeria8.jpg" class="gallery-lightbox" data-gall="gallery-item">
                <img src="../client-site/assets/img/galeria8.jpg" alt="" class="img-fluid" style="height: 350px; width: 100%;">
              </a>
            </div>
          </div>
