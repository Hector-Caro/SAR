...
<head>
  ...
  <title>Registrar Sede - SAR</title>
    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="py-3 mb-4"><span class="text-muted fw-light">Sedes /</span> Registrar</h4>

          <h5>Registrar Sede</h5>
          <p class="mb-4">
            Por favor completa los campos para registrar una sede.
          </p>
          <div class="row">
            <div class="col-md-12">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="../../Controllers/registrarSede.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <select name="direccion" class="select2 form-select" placeholder="Suba">
                      ...
                      <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-2">Registrar Sede</button>
