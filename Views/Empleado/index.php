...
<head>
  ...
  <!-- Page CSS -->
  <link rel="stylesheet" href="../Administrador/css/spinner.css">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light"></span> Menú</h4>
            ...
            <div class="row">
              <div class="wrapper">
                ...
                <ul class="carousel">
                  <li class="card">
                    <div class="img"><img src="" alt="" draggable="false"></div>
                    <h2>Plato</h2>
