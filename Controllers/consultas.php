        ...
        // Módulos
            ...
            /*  funciones de usuario (Cliente) */
                ...
                public function actualizarFotoUser($id, $foto){
                    ...
                    echo "<script>
                            location.href='../Views/Usuario/perfilUser.php?id=$id'
                        </script>";
                }
            ...
            // -Menú
                ...
                public function eliminarPlato($id){
                    ...
                    $eliminar = "DELETE FROM menu WHERE id=:id";
                    $result = $conexion->prepare($eliminar);
                ...
                public function mostrarMenu($idMenu){
                    ...
                    $consultar = "SELECT * FROM menu WHERE id =:idMenu";
                ...
                if ($f['clave'] == $clave) {
                    ...
                    if ($f['estado'] == "Activo" ) {
                        ...
                        switch ($f['rol']) {
                            ...
                            case 'Empleado':
                                echo "<script>
                                    location.href='../Views/Empleado/homeEmpleado.php'
                                </script>";
                            break;
                        }
