...
<body>
    <h2 style="font-family: 'Poppins', sans-serif;">Reporte Productos - SAR</h2>
    ...
    <table class="table table-striped" style="width: 100%; border-collapse: collapse; margin-top: 30px;">
        <thead>
            <tr>
                ...
                <th style="text-align: left; padding: 8px; font-family: 'Poppins', sans-serif; background: #233446; color: #fff;">Categoria</th>
